...
```{r}
# 高年級比例  (10 分)
a <- sum(students==4)+sum(students==5)
b <- sum(students==1)+sum(students==2)+sum(students==3)+sum(students==4)+sum(students==5)
print(a/b)
...
grade_percentage <- function(grades, students) {
  # Modify the code below
  if (typeof(grades)== "chracter") {
  "Freshman" <- sum(students2[students2 == 1])
  "Sophomore" <-sum(students2[students2 == 2])
  "Junior" <- sum(students2[students2 == 3])
  "Senior" <- sum(students2[students2 == 4])
  }
  
  percentage <- length(students2[students2 == grades])/length(students2)
